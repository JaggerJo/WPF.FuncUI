...
module Types =
    ...
    type PropertyAccessor =
        { Name: string
          Getter: (FrameworkElement -> obj) voption
          Setter: (FrameworkElement * obj -> unit) voption }
    ...
    type Accessor =
        ...
        | AvaloniaProperty of DependencyProperty
    ...
    type Subscription =
        { Name: string
          Subscribe:  FrameworkElement * Delegate -> CancellationTokenSource
          Func: Delegate
          FuncType: Type
          Scope: obj }
    ...
    type IView =
        ...
        abstract member Outlet: (FrameworkElement -> unit) voption with get
    ...
    type View<'viewType> =
        { ViewType: Type
          ...
          Outlet: (FrameworkElement -> unit) voption }
