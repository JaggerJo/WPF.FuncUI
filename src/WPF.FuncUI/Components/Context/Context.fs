...
type IComponentContext =
    ...
    /// </para>
    /// </summary>
    abstract attrs: IAttr<Windows.Controls.Border> list -> unit
...
type Context () =
    ...
    let mutable componentAttrs: IAttr<Windows.Controls.Border> list = List.empty
                    ...
                    disposables.Add (
                        state.Subscribe (fun _ ->
                            ...
                            Application.Current.Dispatcher.BeginInvoke(
                                method = Action(fun _ -> (this :> IComponentContext).forceRender()),
    ...
    interface IComponentContext with
        ...
        member this.attrs (attrs: IAttr<Windows.Controls.Border> list) : unit =
